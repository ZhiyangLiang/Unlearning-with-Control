...
# print("------------------------------------------------------")
# get_Utility_Easily("attn_1_thre0.90_onlyx_test2")
# print("------------------------------------------------------")
# get_Utility_Easily("attn_1_thre0.95_onlyx_test2")
# print("------------------------------------------------------")
# get_Utility_Easily("attn_1_thre0.05_onlyx_test2")
# print("------------------------------------------------------")
# get_Utility_Easily("attn_1_thre0.10_onlyx_test2")

# get_Utility_Easily("attn_1_thre0.85_onlyx_first_test2")
# get_Utility_Easily("attn_1_thre0.85_onlyx_middle_test2")
# get_Utility_Easily("attn_1_thre0.85_onlyx_last_test2")

# get_Utility_Easily("attn_1_thre0.85_onlyx_fc_test2")
# get_Utility_Easily("attn_1_thre0.85_onlyx_first_part2_test2")

# get_Utility_Easily("attn_1_onlyx_worobust_womaintain")
# get_Utility_Easily("attn_1_onlyx_test2_womaintain")
# get_Utility_Easily("attn_1_onlyx_worobust")
# get_Utility_Easily("attn_1_onlyx_test2")
# get_Utility_Easily("ga_worobust_womaintain")
# get_Utility_Easily("ga_test2_womaintain")
# get_Utility_Easily("ga_worobust")
# get_Utility_Easily("ga_test2")
# get_Utility_Easily("attn_1_onlyx_worobust")
# get_Utility_Easily("attn_1_onlyx_test2")

get_Utility_Easily("attn_150_onlyx_maintain_robust_4")
print("------------------------------------------------------")
