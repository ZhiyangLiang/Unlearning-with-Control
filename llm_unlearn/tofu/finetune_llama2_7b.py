...
def main(cfg):
    ...
    max_steps = int(int(cfg["num_epochs"]) * len(torch_format_dataset)) // (
    ...
    model = AutoModelForCausalLM.from_pretrained("meta-llama/Llama-2-7b-chat-hf", token=access_token, cache_dir="./")
    ...
    model.save_pretrained(cfg["save_dir"], from_pt=True)
    # model.save_pretrained("models/finetune_llama2_7b_chat_hf_tofu", from_pt=True)
    # model.save_pretrained("models/finetune_llama2_7b_chat_hf_tofu_retrain99", from_pt=True)
    # model.save_pretrained("models/finetune_llama2_7b_chat_hf_tofu_retrain95", from_pt=True)
    # model.save_pretrained("models/finetune_llama2_7b_chat_hf_tofu_retrain90", from_pt=True)
