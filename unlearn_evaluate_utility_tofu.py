...
from utils import create_tofu_dataloader_from_dataset, create_tofu_dataloader_from_dataset_perturbed
import pdb
...
def eval_dataset(data_name, model, tokenizer, eval_log1, eval_log2):
    ...
    idx = 0
    for forget_original_batch, forget_perturbed_batch_0, forget_perturbed_batch_1, forget_perturbed_batch_2 in zip(forget_loader_original, forget_loader_perturbed_0, forget_loader_perturbed_1, forget_loader_perturbed_2):
        ...
        forget_perturbed_loss = (forget_perturbed_loss_0 + forget_perturbed_loss_1 + forget_perturbed_loss_2) / 3
        ...
        eval_log2.info(forget_perturbed_loss.item())
        print(stats)
        idx += 1
