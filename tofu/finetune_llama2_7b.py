...
def main(cfg):
    ...
    model.save_pretrained("models/finetune_llama2_7b_tofu", from_pt=True)
    # model.save_pretrained("models/finetune_llama2_7b_tofu_retrain99", from_pt=True)
    # model.save_pretrained("models/finetune_llama2_7b_tofu_retrain95", from_pt=True)
    # model.save_pretrained("models/finetune_llama2_7b_tofu_retrain90", from_pt=True)
